...
//        String uri = "@drawable/green";
//        int imageResource = getResources().getIdentifier(uri, null, getPackageName());
//        loadBitmap(imageResource, background);
        // Instantiate a ViewPager and a PagerAdapter.
        mPager = (ViewPager) findViewById(R.id.pager);
        mPager.setBackgroundDrawable(getResources().getDrawable(R.drawable.green) );
    ...
    /**
     * A simple pager adapter that represents 5 {@link MailruSlidePageFragment} objects, in
     * sequence.
     */
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            return MailruSlidePageFragment.create(position);
        }
